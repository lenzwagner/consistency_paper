...
def column_generation_naive(data, demand_dict, eps, Min_WD_i, Max_WD_i, time_cg_init, max_itr, output_len, chi, threshold, time_cg, I, T, K, epsi, scale, sp_solver='mip', use_null_column=False, worker_groups=None):
    # **** Column Generation ****
    # Prerequisites
